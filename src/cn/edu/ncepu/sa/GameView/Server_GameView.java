 ...
 * 游戏窗口
 */
public class Server_GameView extends JFrame {
    /**
     * 数据区引用
     */
    WarData warData;
   ...
   // JLabel statuskillLabel = new JLabel("杀敌数: 0");
     ...
     * @param warData 数据区引用
     */
    public Server_GameView(WarData warData) {
       ...
       // statuskillLabel.setFont(font2);
        ...
        // 注意：不再需要调整窗口大小，因为BorderLayout会自动管理
//        this.add(panel);
//
...
//        this.setSize(width + cw, height + ch);
     ...
     */
    public void updateDataSet(WarData warData) {
        HashSet<Element> elements = warData.elements;
        Tank userTank= warData.userTank;
        // 删除中间的元素会有问题
